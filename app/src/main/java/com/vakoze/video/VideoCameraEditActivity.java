...
public class VideoCameraEditActivity extends AppCompatActivity implements VideoEffectsFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_camera_edit);
