...
import vakoze.blomidtech.vakoze.ModifierInfosActivity;
import vakoze.blomidtech.vakoze.R;
import vakoze.blomidtech.vakoze.TimelineActivity;
...
public class ProfilFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(user.getProfile_pic()!=null&&!user.getProfile_pic().isEmpty()&&!user.getProfile_pic().equals("")){
            ...
            Glide.with(getActivity())
                    //.load(user.getProfile_pic())
                    .load(Uri.parse("android.resource://vakoze.blomidtech.vakoze/" + R.drawable.profile_pic))
                    //.fitCenter()
                    .into(profile_pic);
        }
    ...
    public void displayToast(String message){
        Snackbar snackbar = Snackbar
                .make(profilView, message, Snackbar.LENGTH_LONG)
