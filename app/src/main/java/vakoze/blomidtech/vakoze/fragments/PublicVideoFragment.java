...
import vakoze.blomidtech.vakoze.lib.MyDividerItemDecoration;
 ...
 * interface.
 */
public class PublicVideoFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, RecyclerView.OnTouchListener, PublicVideoAdapter.PublicVideoAdapterListener{
    ...
    private PublicVideoAdapter adapter;
                ...
                new Response.Listener<NetworkResponse>() {
                    ...
                    public void onResponse(NetworkResponse response) {
                        try {
                            ...
                            if (videoGroupList!=null) {
                                //Toast.makeText(getContext(), videoGroupList.get(1).getNom(), Toast.LENGTH_SHORT).show();
                                adapter = new PublicVideoAdapter( getActivity(), videoGroupList);
                            }
                            recyclerView.setAdapter(adapter);
                            */
