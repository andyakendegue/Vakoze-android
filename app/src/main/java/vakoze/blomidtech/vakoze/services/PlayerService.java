package vakoze.blomidtech.vakoze.services;
...
public class PlayerService extends Service implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    void setUpAsForeground(String text) {
        /*
        PendingIntent pi =
                PendingIntent.getActivity(getApplicationContext(), 0, new Intent(getApplicationContext(), BoxActivity.class),
